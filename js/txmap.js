...
$.ajax({
    ...
    data: {
        key: '5ZDBZ-X3FWJ-XE7FF-XFFFQ-6MDGZ-X6BPB',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(103.82759,30.687585, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
